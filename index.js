...
router.get("/ultrasonic", (req) => {
  rootDiv.innerHTML = ultra;
  console.log("home");
});

router.get("/touch", (req) => {
  rootDiv.innerHTML = touch;
  console.log("home");
});

router.get("/color", (req) => {
  rootDiv.innerHTML = color;
  console.log("home");
});

router.get("/gyro", (req) => {
  rootDiv.innerHTML = gyro;
  console.log("home");
});
router.init();
